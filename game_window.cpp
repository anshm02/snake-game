...
void print_welcome_screen(gamewindow_t* r) {

	attron(COLOR_PAIR(1));
	mvprintw(r->upper_left_y + 2, r->upper_left_x + 5, "Welcome to my game!");
    mvprintw(r->upper_left_y + 4, r->upper_left_x + 2, "Use arrow keys to move.");
    mvprintw(r->upper_left_y + 5, r->upper_left_x + 2, "Press 'q' to quit.");
	attron(COLOR_PAIR(1));
